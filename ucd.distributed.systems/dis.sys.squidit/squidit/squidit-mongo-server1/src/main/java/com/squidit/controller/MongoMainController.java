...
public class MongoMainController {
  ...
  // ===========================================================================
  // MONGO OPERATION MAPPING -  SEND TO MONITOR
  // ===========================================================================
  
  @GetMapping("mongoMonitorStatus")
  @RequestMapping(value = "mongoMonitorStatus", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<String> mongoMonitorStatus() throws IOException { // Create counter to see how many videos database has
    int counter = 0;
    ...
    objectNode1.put("mongoName", "mongo-server1");
    objectNode1.put("mongoUrlSlot", 0);
  ...
  public ResponseEntity mongoDeleteDB() {
    ...
    // MongoClient mongoClient2 = new MongoClient(new ServerAddress("localhost", 27018));
    // MongoClient mongoClient3 = new MongoClient(new ServerAddress("localhost", 27019));
    DB db1 = mongoClient1.getDB("squidit-mongodb1");
    DB db2 = mongoClient1.getDB("squidit-mongodb2");
    DB db3 = mongoClient1.getDB("squidit-mongodb3");
    db1.dropDatabase();
    db2.dropDatabase();
    db3.dropDatabase();
    return new ResponseEntity<>(HttpStatus.ACCEPTED);
