...
public class SaavnFilter {
  ...
  public static class MapperClass extends
      Mapper<LongWritable, Text, SongIDDateWritable, IntWritable> {

    public static List<String> days = Arrays
        .asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14",
  ...
  public static class ReducerClass extends
      Reducer<SongIDDateWritable, IntWritable, SongIdDateCount, Text> {

    public void reduce(SongIDDateWritable key, Iterable<IntWritable> valueList,
        Context con) throws IOException, InterruptedException {

      int song_count = 0;
      for (IntWritable count : valueList) {
        song_count += count.get();
      }
